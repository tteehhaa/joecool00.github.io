...
<body>
    ...
    <footer>
        <div class="container">
            <p class="author-bio">Senior Legal & Commercial Counsel | Tech-Sector Specialist | NY-Qualified Attorney | Seoul, Korea. 인공지능과 비즈니스의 융합을 연구하며 전문적인 기술-법률적 통찰을 기록하는 소담-킹콩노트의 데이터 아카이브입니다.</p>
